    ...
    return (
        <div className="2xl:container h-screen m-auto">
            <div hidden className="fixed inset-0 w-7/12 lg:block">
                <span className="absolute left-6 bottom-6 text-sm">Foto by CHARING-U</span>
                <img src="/foto/loginLog.jpg" alt="login logo Caring-U" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="relative h-full ml-auto lg:w-6/12">
                <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
                    <div className="space-y-4 flex justify-center flex-col items-center">
                        ...
                        <p className="font-medium text-lg text-gray-600">Welcome to Caring U !</p>
                    </div>

                    <div role="hidden" className="mt-12 border-t">
                        <span className="block w-max mx-auto -mt-3 px-4 text-center text-gray-500 bg-white">Login</span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 py-6">
                        ...
                        <div>
                            ...
                            <p class="border-t pt-6 text-sm">
                                ...
                                <button onClick={() => navigate("/register")} className="text-sky-500">
                                    Sign up
                                </button>
                            </p>
                        </div>
